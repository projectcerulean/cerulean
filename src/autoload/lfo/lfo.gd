...
func _process(delta: float) -> void:
	...
	var angle = Time.get_unix_time_from_system() * (TAU * bpm / seconds_per_minute)
...
func _on_bgm_changed(sender: Node, bgm_resource: BgmResource):
