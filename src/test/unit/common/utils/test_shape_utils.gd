...
const calculate_shape_volume_box_shape_params: Array = [
	[Vector3(0.0, 0.0, 0.0), 0.0],
	[Vector3(1.0, 2.0, 3.0), 6.0],
	[Vector3(4.0, 5.0, 6.0), 120.0],
]

const get_shape_height_box_shape_params: Array = [
	[Vector3(0.0, 0.0, 0.0), 0.0],
	[Vector3(1.0, 2.0, 3.0), 2.0],
	[Vector3(4.0, 5.0, 6.0), 5.0],
]

const get_shape_height_capsule_shape_params: Array = [
	[Vector2(0.25, 1.0), 1.0],
	[Vector2(0.25, 2.0), 2.0],
	[Vector2(0.25, 3.0), 3.0],
]

const get_shape_scaled_xy_box_shape_params: Array = [
...
const get_shape_scaled_xy_capsule_shape_params: Array = [
...
func test_calculate_shape_volume_box_shape(params: Array = use_parameters(calculate_shape_volume_box_shape_params)) -> void:
	var box_shape: BoxShape3D = BoxShape3D.new()
	box_shape.size = params[0]
	@warning_ignore("unsafe_cast")
	assert_almost_eq(ShapeUtils.calculate_shape_volume(box_shape), params[1] as float, ERROR_INTERVAL)


func test_get_shape_height_box_shape(params: Array = use_parameters(get_shape_height_box_shape_params)) -> void:
	var box_shape: BoxShape3D = BoxShape3D.new()
	box_shape.size = params[0]
	@warning_ignore("unsafe_cast")
	assert_almost_eq(ShapeUtils.get_shape_height(box_shape), params[1] as float, ERROR_INTERVAL)


func test_get_shape_height_capsule_shape(params: Array = use_parameters(get_shape_height_capsule_shape_params)) -> void:
	...
	capsule_shape.height = params[0].y
	@warning_ignore("unsafe_cast")
	assert_almost_eq(capsule_shape.radius, params[0].x as float, ERROR_INTERVAL)
	@warning_ignore("unsafe_cast")
	assert_almost_eq(capsule_shape.height, params[0].y as float, ERROR_INTERVAL)
	@warning_ignore("unsafe_cast")
	assert_almost_eq(ShapeUtils.get_shape_height(capsule_shape), params[1] as float, ERROR_INTERVAL)


func test_get_shape_scaled_xz_box_shape(params: Array = use_parameters(get_shape_scaled_xy_box_shape_params)) -> void:
...
func test_get_shape_scaled_xz_capsule_shape(params: Array = use_parameters(get_shape_scaled_xy_capsule_shape_params)) -> void:
